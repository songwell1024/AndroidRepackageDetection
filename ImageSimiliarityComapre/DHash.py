...
def calculate_hash(image):
    ...
    """
    difference = DHash__difference(image)
...
def hamming_distance(first, second):
    ...
    # B. image计算汉明距离
    hamming_distance = 0
    image1_difference = DHash__difference(first)
    image2_difference = DHash__difference(second)
